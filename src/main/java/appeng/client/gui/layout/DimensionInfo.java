...
public abstract class DimensionInfo {
    ...
    public final LayoutElement getComponent(final int componentIndex){
    ...
    private int getCellSizePolicyFromInheriting(final int cellIndex) {
        ...
        for(int i=getComponentCount() - 1; i >= 0; i--) {
            ...
            LayoutElement child = getComponent(i);
    ...
    public static Container findAlignedChild(final LayoutElement child, final GridConstraints c) {
    ...
    protected final LytSize getPreferredSize(final int componentIndex){
        LytSize size = myLayoutState.myPreferredSizes[componentIndex];
        if (size == null) {
    ...
    protected final LytSize getMinimumSize(final int componentIndex){
        LytSize size = myLayoutState.myMinimumSizes[componentIndex];
        if (size == null) {
