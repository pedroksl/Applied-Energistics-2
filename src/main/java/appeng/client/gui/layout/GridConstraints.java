...
public final class GridConstraints implements Cloneable {
     ...
     */
    public  LytSize myPreferredSize;

    /**
     * @see #myPreferredSize
     */
    public  LytSize myMaximumSize;
    ...
    public GridConstraints(){
        ...
        myMinimumSize = new LytSize(-1, -1);
        myPreferredSize = new LytSize(-1, -1);
        myMaximumSize = new LytSize(-1, -1);
        myIndent = 0;
    }
    ...
    public GridConstraints(
            ...
            final LytSize minimumSize,
            final LytSize preferredSize,
            final LytSize maximumSize) {
        myRow = row;
        myColumn = column;
        myRowSpan = rowSpan;
        myColSpan = colSpan;
        ...
        myMinimumSize = minimumSize != null ? minimumSize : new LytSize(-1,-1);
        myPreferredSize = preferredSize != null ? preferredSize : new LytSize(-1,-1);
        myMaximumSize = maximumSize != null ? maximumSize : new LytSize(-1,-1);
        myIndent = 0;
    }
    ...
    public Object clone() {
        return new GridConstraints(
                ...
                myMinimumSize, myPreferredSize, myMaximumSize, myIndent, myUseParentLayout);
    }
    ...
    public GridConstraints store() {
        ...
        copy.myMinimumSize = myMinimumSize;
        copy.myPreferredSize = myPreferredSize;
        copy.myMaximumSize = myMaximumSize;
    ...
    public void restore(final GridConstraints constraints) {
        ...
        // Restore sizes
        myMinimumSize = constraints.myMinimumSize;
        myPreferredSize = constraints.myPreferredSize;
        myMaximumSize = constraints.myMaximumSize;
    }
