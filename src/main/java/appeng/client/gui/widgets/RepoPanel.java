...
public class RepoPanel extends Container {
    ...
    private int availableWidth() {
        return bounds.getWidth() - scrollbar.getLayoutBounds().getWidth();
    }
...
//        scrollbar.setRange(0, totalRows - this.rows, Math.max(1, this.rows / 6));
    ...
    private void updateLayout() {
        ...
        scrollbar.setPosition(bounds.getX() + bounds.getWidth() - scrollbar.getLayoutBounds().getWidth(), bounds.getY());
    ...
    public void drawBackgroundLayer(GuiGraphics guiGraphics, Rect2i bounds, Point mouse) {
        var left = bounds.getX() + this.bounds.getX();
        var top = bounds.getY() + this.bounds.getY();
        var right = bounds.getX() + this.bounds.getX() + this.bounds.getWidth();
        var bottom = bounds.getY() + this.bounds.getY() + this.bounds.getHeight();
